<template>
  <section class="ce-small-business-interior">
    <HeaderProgressBar :percentage="scenePositionProgress" />

    <div class="ce-small-business-interior__viewport">
      <LocationSelector
      ...
      >
        <template #hotspotItems>
          <HotspotDefault
            ...
            heightPerc="48%"
            dialogueInfoArrowPos="bottomLeft"
      ...
      <ButtonListOpen
        class="ce-small-business-interior__list-open-btn"
    ...
    <SoundAmbient
      url="https://scottduncancreative.com/archive/consumers-energy/sounds/small-business-interior__ambient.mp3"
      ref="ambientSound"
    />
  </section>
</template>
...
export default {
  ...
  methods: {
    initScene() {
      ...
      this.scenesViewedStore.smallBusinessInterior = true
...
.ce-small-business-interior__viewport {
  flex: 1;
  overflow: hidden;
  position: relative;
  width: 100%;
