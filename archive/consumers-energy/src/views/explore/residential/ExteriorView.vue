<template>
  <section class="ce-residential-exterior">
    <HeaderProgressBar :percentage="scenePositionProgress" />

    <div class="ce-residential-exterior__viewport">
      <LocationSelector
      ...
      >
        ...
        <template #backgroundSceneImages>
          ...
          <AnimNonInteractive
            ...
            :depth-X="Number(0)"
            :depth-y="Number(0)"
            height-percentage="23%"
            left-percentage="0%"
            top-percentage="0%"
            type="Anim"
            url="https://scottduncancreative.com/archive/consumers-energy/anims/residential-exterior__hot-air-balloon.json"
            :zindex="Number(1)"
          />
          ...
          <AnimNonInteractive
            ...
            top-percentage="0%"
            type="Anim"
            url="https://scottduncancreative.com/archive/consumers-energy/anims/residential-exterior__birds.json"
            :zindex="Number(2)"
          />
        </template>
      </InteractiveScene>
      ...
      <ButtonListOpen
        class="ce-residential-exterior__list-open-btn"
    ...
    <SoundAmbient
      url="https://scottduncancreative.com/archive/consumers-energy/sounds/residential-exterior__ambient.mp3"
      ref="ambientSound"
    />
  </section>
</template>
...
export default {
  ...
  methods: {
    initScene() {
      this.scenesViewedStore.residentialExterior = true
...
.ce-residential-exterior__viewport {
  flex: 1;
  overflow: hidden;
  width: 100%;
}
