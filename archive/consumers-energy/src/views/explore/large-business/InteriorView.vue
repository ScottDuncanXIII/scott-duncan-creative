<template>
  <section class="ce-large-business-interior">
    <HeaderProgressBar :percentage="scenePositionProgress" />

    <div class="ce-large-business-interior__viewport">
      <LocationSelector
      ...
      <ButtonListOpen
        class="ce-large-business-interior__list-open-btn"
    ...
    <SoundAmbient
      url="https://scottduncancreative.com/archive/consumers-energy/sounds/large-business-interior__ambient.mp3"
      ref="ambientSound"
    />
  </section>
</template>
...
export default {
  ...
  methods: {
    initScene() {
      ...
      this.scenesViewedStore.largeBusinessInterior = true
...
.ce-large-business-interior__viewport {
  flex: 1;
  overflow: hidden;
  position: relative;
  width: 100%;
