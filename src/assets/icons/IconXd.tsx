export default function IconXd({ color }: { color: string }) {
  return (
    <svg
      className="svg-icon"
    ...
    >
      <g fillRule="nonzero">
        <path
          d="m42.5 0h155c23.5 0 42.5 19 42.5 42.5v149c0 23.5-19 42.5-42.5 42.5h-155c-23.5 0-42.5-19-42.5-42.5v-149c0-23.5 19-42.5 42.5-42.5z"
          fill={color}
        />
        <g fill="#171617">
